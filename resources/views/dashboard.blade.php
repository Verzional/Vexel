<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div class="p-6 rounded-2xl bg-gradient-to-br from-[#667EEA] to-[#764BA2] text-white shadow-lg shadow-indigo-200">
    ...
    <div>
        ...
        <div class="bg-[#EBEBFF] rounded-3xl overflow-hidden p-1 border border-indigo-50">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="text-gray-800 font-bold border-b border-gray-200/50">
                    ...
                    <tr class="hover:bg-white/50 transition-colors">
                        ...
                        <td class="py-4 px-6">
                            @if($activity->type == 'Rubric')
                                <span class="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-xs font-bold">Rubric</span>
                            @elseif($activity->type == 'Assignment')
                                <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-bold">Assignment</span>
                            @else
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-xs font-bold">{{ $activity->type }}</span>
                            @endif
                        </td>
                    </tr>
                    @empty
